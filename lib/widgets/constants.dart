...
//Colors
const colorOne = Color(0xFF000000);
const colortwo = Color(0xFF86003c);
const colorthree = Color(0xFFE41F7B);
const colorfour = Color(0xFFFFFFFF);
const colorfive = Color(0xFFff8ba0);
